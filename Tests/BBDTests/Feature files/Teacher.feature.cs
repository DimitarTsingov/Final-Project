...
#line hidden
#line 6
 await testRunner.GivenAsync("user signs in with \"Dimitar\" username and \"teacher11\" password.", ((string)(null)), ((global::Reqnroll.Table)(null)), "Given ");
#line hidden
        }
...
#line hidden
#line 14
 await testRunner.ThenAsync(string.Format("validate that the class is successfully created \"{0}\".", message), ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Add the stuednt to a class")]
        [NUnit.Framework.CategoryAttribute("Positive_flow")]
        ...
        public async System.Threading.Tasks.Task AddTheStuedntToAClass(string name, string class_Id, string message, string[] exampleTags)
        {
            string[] @__tags = new string[] {
                    "Positive_flow"};
            if ((exampleTags != null))
            ...
            argumentsOfScenario.Add("message", message);
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("Add the stuednt to a class", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 22
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((global::Reqnroll.TagHelper.ContainsIgnoreTag(scenarioInfo.CombinedTags) || global::Reqnroll.TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
#line 23
 await testRunner.WhenAsync(string.Format("teacher adds the student with \"{0}\" name and \"{1}\" class id.", name, class_Id), ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 24
 await testRunner.ThenAsync(string.Format("validate that the student is successfully added \"{0}\".", message), ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
...
#line hidden
#line 34
 await testRunner.WhenAsync("teacher adds this grade: \"3\", to student: \"2164e5a5-8c01-40e4-9210-6f38476cdd2a\"," +
                        " in subject: \"Biologic\".", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 35
 await testRunner.ThenAsync("validate that the grade is successfully added to the student \"Grade added\".", ((string)(null)), ((global::Reqnroll.Table)(null)), "Then ");
#line hidden
#line 36
 await testRunner.AndAsync("teacher updates the grade to \"6\".", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
#line 37
 await testRunner.AndAsync("validate that the grade is successfully updated \"Grade updated\".", ((string)(null)), ((global::Reqnroll.Table)(null)), "And ");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
